<template>
  <div
    class="overflow-hidden sm:mr-2 max-w-[366px] w-[50%] hover:shadow-md transition flex flex-col group cursor-pointer relative"
  >
    <NuxtLink :to="link" class="card h-full">
      ...
      <div class="p-4">
        ...
        <p
          class="font-normal text-[12px] sm:text-[14px] md:text-[16px] lg:text-[18px] line-clamp-3 my-2"
        >
          {{ description }}
        </p>
