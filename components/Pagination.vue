    ...
    <div>
        <div class="inline-flex gap-2">
            <button type="button" @click="onClickFirstPage" :disabled="isInFirstPage" aria-label="Go to first page"
                class="btn btn-sm h-10" v-if="includeFirstLast">
                First
            </button>

            <button type="button" @click="onClickPreviousPage" :disabled="isInFirstPage" aria-label="Go to previous page"
                class="btn btn-sm h-10" v-if="includeNextPrev">
                Prev
            </button>

            <button v-for="page in pages" type="button" @click="onClickPage(page.name)" :disabled="page.isDisabled"
