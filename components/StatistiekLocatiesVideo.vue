<template>
  <section
    class="bg-white lg:py-20 relative flex items-center"
    :class="classcustom"
  >
    <div class="grid md:grid-rows-1 md:grid-cols-12 z-10 container-custom">
      ...
      <div class="grid relative mt-5 justify-items-end col-span-7">
        <div
          class="w-[80%] min-[500px]:w-[70%] sm:w-[80%] lg:w-[100%] relative"
        >
        ...
        <div
          class="bg-primary grid grid-rows-1 grid-cols-3 z-10 absolute bottom-10 lg:bottom-20 right-4 lg:right-20 w-[90%] min-[500px]:w-[80%] md:w-[98%] content-center justify-items-center py-2 lg:py-5 rounded-2xl md:rounded-[30px] px-4 lg:px-10"
        >
          <div class="text-white">
            <p class="text-[24px] min-[500px]:text-[36px] font-semibold">
              {{ count1 }} <span class="text-[#00985B]">+</span>
            </p>
            <p class="text-[12px] min-[500px]:text-[16px] font-normal">
              {{ titleBg1 }}
            </p>
          </div>
          <div class="text-white">
