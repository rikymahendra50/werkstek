<template>
  <div class="lg:py-20 py-10 mt-20">
    ...
    <!-- ini -->
    <div
      class="container-custom mt-[-100px] sm:mt-[-50px] min-[700px]:mt-[10px] lg:mt-[-220px]"
    >
      <div
        class="bg-white w-full lg:w-[95%] rounded-[20px] py-4 sm:grid sm:grid-cols-12 shadow-md"
      >
        <!-- col1 -->
        <div
