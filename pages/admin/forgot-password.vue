    ...
    <div class="hero min-h-screen">
        <div class="hero-content text-center">
            <div class="max-w-md">
                ...
                <ForgotPasswordVerifiedOTP v-if="stepper.isCurrent('otp')" v-model:otp="stateForm.otp"
                    :email="stateForm.email" @next="() => stepper.goTo('change-password')" />

                <ForgotPasswordChange v-if="stepper.isCurrent('change-password')" :email="stateForm.email"
                    :otp="stateForm.otp" @next="goToHome" />
