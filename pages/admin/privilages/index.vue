  ...
  <main class="flex-grow overflow-y-auto">
    ...
    >
      <div class="flex justify-between items-center">
        <div>
          <div class="text-xl md:text-3xl font-bold">Privilages</div>
        </div>
        <div>
          <CompAdminButtonAddIndex name="Privilages" link="privilages" />
        </div>
      </div>
      <div>
            ...
            <tbody>
              ...
              >
                ...
                <td class="flex justify-center gap-4 my-1">
                  <NuxtLink
                    :to="`/admin/privilages/edit/${item.slug}`"
                  ...
                  <dialog :id="'my_modal_' + index" class="modal">
                    <div class="modal-box">
                      ...
                      <div class="modal-action">
                        <form method="dialog">
                          <button
                            @click="deletePrivilages(item.slug)"
...
const {
  ...
  error,
  refresh,
} = await useFetch(`/admins/categories`, {
  method: "get",
  ...requestOptions,
});
...
const deletePrivilages = async (slug) => {
  loading.value = true;
  await useFetch(`/admins/categories/${slug}`, {
    method: "DELETE",
    ...requestOptions,
  });
  ...
  if (error.value) {
    ...
    snackbar.add({
      type: "success",
      text: "Delete Privilages Success",
    });
